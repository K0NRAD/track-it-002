...
public interface DailyWorkingHoursRepository extends JpaRepository<DailyWorkingHours, Long> {
    ...
    static void updateCheckOutTotalBreakTimeTotalWorkTime(LocalTime checkOutTime, LocalTime totalBreakTime, LocalTime totalDayWorkTime, Long dailyWorkingHoursId) {
    }
